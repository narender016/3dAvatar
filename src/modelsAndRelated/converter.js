...
// export default function createAnimation(recordedData, morphTargetDictionary, bodyPart) {
//   debugger
//   if (recordedData.length !== 0 && morphTargetDictionary) {
//     let animation = []
...
//     recordedData.forEach((eachRecordedData, index) => {
//       Object.entries(eachRecordedData.blendshapes).forEach(([key, value]) => {
...
//     // console.log("Animation json to animate: ", animation);
//     let tracks = []
